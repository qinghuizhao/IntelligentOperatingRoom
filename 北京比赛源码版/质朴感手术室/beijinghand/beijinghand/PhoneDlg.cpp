...
void CPhoneDlg::startPhone()
{
	...
	m_phone0.InitControl(IDB_BITMAP5, IDB_smallwaike, IDB_bigwaike);	//设置图片
	m_phone1.InitControl(IDB_BITMAP5, IDB_smallshenjing, IDB_bigshenjing);	//设置图片
	m_phone2.InitControl(IDB_BITMAP6, IDB_smallneike, IDB_bigneike);
	m_phone3.InitControl(IDB_BITMAP7, IDB_smallwuguan, IDB_bigwuguan);
	m_phone4.InitControl(IDB_BITMAP6, IDB_smallchuanran, IDB_bigchuanran);
	if(phone1_2==TRUE){
		nfrphone=1;
		phone4=TRUE;
		nStop=TRUE;
...
void CPhoneDlg::OnPaint()
{
	...
	CBitmap    bitmap;  
	//从资源中载入位图  
	bitmap.LoadBitmap(IDB_callback);  
