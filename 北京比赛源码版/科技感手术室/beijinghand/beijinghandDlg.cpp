...
void CbeijinghandDlg::InitUI()
{
	...
	m_staVersion.SetTextClr(RGB(255,255,255));
	m_staAuthor.SetTextClr(RGB(255,255,255));
	m_staEmail.SetCommonMode();
 	m_staEmail.SetTextClr(RGB(255,255,255));
...
// 	m_staEmail.SetTextClr(RGB(73,41,62));
    ...
    m_stastart.InitControl(IDB_jianbeijing1, IDB_xiaorun, IDB_zhongnan);
	m_sta0.InitControl(IDB_jianbeijing1, IDB_smallread, IDB_bigread);	//设置图片
	m_sta1.InitControl(IDB_jianbeijing2, IDB_smallphone, IDB_bigphone);
	m_sta2.InitControl(IDB_jianbeijing3, IDB_smallchuang, IDB_bigchuang);
