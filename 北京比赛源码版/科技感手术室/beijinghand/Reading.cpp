...
{
	read1 = imread("res/bCK1.bmp");
	read2 = imread("res/bCK1.bmp");
	read3 = imread("res/bCK1.bmp");
	read4 = imread("res/bCK1.bmp");
	read5 = imread("res/bCK1.bmp");
...
void CReading::YueP(){
	...
	m_s4.SetTextFont( 9, 0, 0, _T("宋体") );
		//设置图片
	m_s0.InitControl(IDB_jianbeijing1, IDB_smallwaike, IDB_bigwaike);	//设置图片
	m_s1.InitControl(IDB_jianbeijing2, IDB_smallshenjing, IDB_bigshenjing);
	m_s2.InitControl(IDB_jianbeijing3, IDB_smallneike, IDB_bigneike);
	m_s3.InitControl(IDB_jianbeijing4, IDB_smallwuguan, IDB_bigwuguan);
	m_s4.InitControl(IDB_jianbeijing5, IDB_smallchuanran, IDB_bigchuanran);
	if(readP1_2==TRUE){
		nfrread=1;
		readP4=TRUE;
		nStop=TRUE;
